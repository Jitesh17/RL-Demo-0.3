...
internal enum SpeedType
    ...
    {
        [SerializeField] private int colWheels = 4; //the number of wheels that can rotate, can be used for the trailer
    ...
    [SerializeField] private CarDriveType m_CarDriveType = CarDriveType.FourWheelDrive;
        ...
        [SerializeField] private float m_ChangeSteerAngle = 5;
        ...
        [SerializeField] private float m_FullTorqueOverAllWheels = 1400;
        [SerializeField] private float m_ReverseTorque = 300;
        [SerializeField] private float m_MaxHandbrakeTorque = 100_000_000;
        ...
        switch(m_CarSteerType)
        {
            case CarSteerType.FrontSteerWheels:
                m_SteerAngle = Mathf.MoveTowards(m_WheelColliders[0].steerAngle, m_SteerAngle, m_ChangeSteerAngle * Time.deltaTime);
                m_WheelColliders[0].steerAngle = m_SteerAngle;
                m_WheelColliders[1].steerAngle = m_SteerAngle;
                break;
            case CarSteerType.RearSteerWheels:
                m_SteerAngle = Mathf.MoveTowards(m_WheelColliders[2].steerAngle, m_SteerAngle, m_ChangeSteerAngle * Time.deltaTime);
    ...
    */
            ...
            if (handbrake > 0f)
            {
                ...
                hbTorque = Mathf.MoveTowards(m_WheelColliders[2].brakeTorque, hbTorque, m_MaxHandbrakeTorque * Time.deltaTime);
